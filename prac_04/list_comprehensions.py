...
longer_than_eleven = [name for name in full_names if len(name) >= 12] #add an extra character to account for space
last_name = [name.split()[-1] for name in longer_than_eleven]
